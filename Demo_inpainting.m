...
SampleRate = SampleRate_Levels(1) ; %% 30% precent missing ;
Sigma = Sigma_Levels(1) ; %% Noise level 10 ;
...
opts.tol = 5e-4;
opts.maxit = 50; 
opts.maxIt = 4 ; % the maximum stage number
opts.mu = 0.02 ;
opts.lambda = 2.0 ;
opts.gamma = 0;
